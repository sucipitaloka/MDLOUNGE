...
<html lang="en">
<head>
	<title>Login | MDLOUNGE</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
<!--===============================================================================================-->

	<link rel="icon" type="image/png" href="template/masuk/images/icons/mdlogofw1.png"/>
<!--===============================================================================================-->
...
<body>
	<div class="limiter">
		<div class="container-login100" style="background-image: url('template/masuk/images/bgwebnako.jpg');">
			<div class="wrap-login100 p-t-120 p-b-30">
				<form action="" method="post" class="login100-form validate-form">
					...
					<div class="login100-form-avatar">
						<img src="template/masuk/images/mdlogofw1.png" alt="AVATAR">
					</div>

					<span class="login100-form-title p-t-25 p-b-35">
						MDLOUNGE
					</span>
